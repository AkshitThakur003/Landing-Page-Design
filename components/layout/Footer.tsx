          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                <li><a href="#" className="hover:text-brand-400 transition-colors inline-block">Features</a></li>
                <li><a href="#" className="hover:text-brand-400 transition-colors inline-block">Pricing</a></li>
                <li><a href="#" className="hover:text-brand-400 transition-colors inline-block">Success Stories</a></li>
